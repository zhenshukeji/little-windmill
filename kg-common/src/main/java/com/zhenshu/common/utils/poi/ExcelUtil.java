...
import com.zhenshu.common.exception.UtilException;
import com.zhenshu.common.utils.DateUtils;
import com.zhenshu.common.utils.DictUtils;
import com.zhenshu.common.utils.StringUtils;
import com.zhenshu.common.utils.file.FileTypeUtils;
import com.zhenshu.common.utils.file.FileUtils;
import com.zhenshu.common.utils.file.ImageUtils;
import com.zhenshu.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public List<T> importExcel(String sheetName, InputStream is, int titleNum) throws Exception {
        ...
        if (rows >= Constants.EXCEL_MAX_SIZE) {
            throw new ServiceException(ErrorEnums.IMPORT_SIZE_OVERFLOW);
        }
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        Boolean bool = Convert.toBool(val);
                        if (bool != null) {
                            val = bool;
                        }
                    }
            ...
            if (attr.isExport()) {
                ...
                if (StringUtils.isNotEmpty(dateFormat) && StringUtils.isNotNull(value)) {
                    if (value instanceof Date) {
                        ...
                        String strDate2 = dtf2.format((LocalDateTime) value);
                        cell.setCellValue(strDate2);
                    }
                    // 对枚举进行处理
                } else if (value instanceof IBaseEnum) {
                    cell.setCellValue(((IBaseEnum) value).getInfo());
     ...
     * @param filename 文件名称
     */
    public String getAbsoluteFile(String filename, String downloadPath) {
